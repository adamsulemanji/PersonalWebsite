                  ...
                  <div>
                    ...
                    <div className='mt-3 flex flex-wrap gap-1.5'>
                      {project.categories?.map((category, catIndex) => (
                        <span
                          key={catIndex}
                          className='border-black/10 dark:border-white/20 text-white inline-block rounded-full border px-3 py-1 text-xs font-semibold'
                  ...
                  <div className='flex-1 p-4'>
                    ...
                    <div className='mt-3 flex flex-wrap gap-1.5'>
                      {project.categories?.map((category, catIndex) => (
                        <span
                          key={catIndex}
                          className='border-black/10 dark:border-white/30 text-white hover:border-black/20 dark:hover:border-white/60 inline-block rounded-full border px-3 py-1 text-xs font-semibold transition-all duration-300 hover:scale-105'
                          style={{ backgroundColor: badgeColor }}
                        >
                          {category}
                        </span>
