      ...
      <section className='w-full transform transition-all duration-1000 ease-out'>
        <div className='mt-24 grid w-full grid-cols-1 gap-10 md:grid-cols-2'>
          <div className='leading-relaxed'>
            ...
            <p>
              I was born and raised in Houston, technically Katy for anyone in
              Texas.
            </p>
            <p className='mt-4'>
              Houston is notorisoulsy amazing for their food and sports scene.
              As a lifelong fan of the Houston Astros, Rockets and Texans.
              Currently, my attention is on the Rockets as we have strong
              defensive young core under new coaching. These factors have led
              use to be 2nd in the west, which itself is a extremely hard
              division. In terms of media, I am currently watching Naruto and
              just watched the The Handmaiden{' '}
            </p>
          </div>
          <div className='flex items-center justify-center'>
            <img
