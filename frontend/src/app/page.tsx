                ...
                <div className='grid w-full grid-cols-1 gap-10 md:grid-cols-2'>
                  <div className='items-center justify-center leading-relaxed'>
                    <p>
                      ...
                      <span className='accent font-bold'>Doctor</span> so I
                      tried and pursued{' '}
                      ...
                      coding class in{' '}
                      <span className='accent font-bold'>Python</span> their
                      first semester so I did. Since then, I loved the idea of{' '}
                      <span className='accent font-bold'>programming</span> but
                      even more so the idea of{' '}
                      <span className='accent font-bold'>building</span>.
                    </p>
                    <p className='mt-4'>
                      After my first year, I declared{' '}
                      <span className='accent font-bold'>Computer Science</span>{' '}
                      ...
                      <span className='accent font-bold'>Statistics</span>.
                      ...
                      returning back to{' '}
                      <b className='accent text-xl underline-offset-auto'>
                        Amazon
                      </b>{' '}
              ...
              <div className='mt-24 grid w-full grid-cols-1 gap-10 md:grid-cols-2'>
                ...
                <div className='leading-relaxed'>
                  ...
                  <p>
                    ...
                    for <span className='accent font-bold'>KYS</span> (Katy
                    Youth Soccer) but I realized I wasn't very good. I later
                    switched into{' '}
                    <span className='accent font-bold'>basketball</span> through
                    the local <span className='accent font-bold'>KYB</span>{' '}
                  ...
                  <p className='mt-4'>
                    ...
                    <span className='accent font-bold'>baseball</span> as I
                    realized I could pitch pretty well. But throughout all of
                    this, I was playing{' '}
                    <span className='accent font-bold'>tennis</span> because
                  ...
                  <p className='mt-4'>
                    ...
                    <span className='accent font-bold'>basketball</span> (don't
                    like running), running half marathon races (I like the
                    medals) and trying to become a great{' '}
                    <span className='accent font-bold'>Quarterback</span> in
                    flag football.
                  </p>
                </div>
              </div>
