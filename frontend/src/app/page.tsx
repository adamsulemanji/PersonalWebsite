  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <section
          id="about"
          className="text-7xl font-bold text-center sm:text-left relative one group bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 dark:from-red-600 dark:via-orange-500 dark:to-yellow-400 inline-block text-transparent bg-clip-text transition-opacity duration-2000"
        >
        ...
        <section
          id="projects"
          className="text-lg text-center sm:text-left transition-opacity duration-500"
        >
      ...
      <footer
        id="contact"
        className="row-start-3 flex gap-6 flex-wrap items-center justify-center transition-opacity duration-500"
      >
        <a
